<PageSummary 
    ...
    navIndex={100}
    featuredIndex={2}
    links={[{type: "yt", url: "https://www.youtube.com/watch?list=PLZLcR3tglTH_-BFpk8cMS5SfBNZJMNrut&v=F9CQYqj4H8s"}]}
>
...
I decided to 3d model and print a functional hidden-blade similar to those seen Assassin's Creed:
