...
Throughout all of LaunchMenu we've made use of my library [Model-react](./model-react). This library wasn't made specifically for LaunchMenu, but LaunchMenu wouldn't function without it. This is what allows us to keep LaunchMenu very flexible, yet keep the entire state and UI synchronized.
...
You can read more about model-react on [its own dedicated page](./model-react).
